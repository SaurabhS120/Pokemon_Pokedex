...
class PokemonDetailBaseStatsFragment : Fragment() {
    private lateinit var baseStatsBinding: FragmentPokemonDetailBaseStatsBinding
    ...
    override fun onCreateView(
        ...
        pokemonDetailsViewModel.baseStats.observe(viewLifecycleOwner) {
            baseStatsBinding.apply {
                ...
                hpProgress.progress = it.hp.toInt()
                ...
                if (it.total.isNotEmpty()) totalProgress.progress = it.total.toInt()
            }
        }
